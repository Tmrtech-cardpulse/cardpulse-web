  ...
  return (
    <div style={{ background: "var(--scp-bg)", minHeight: "100vh", padding: "0 0 80px", fontFamily: "'Poppins', -apple-system, BlinkMacSystemFont, sans-serif" }}>
      ...
      <main style={{ maxWidth: 740, margin: "0 auto", padding: "48px 24px" }}>
        ...
        {[
          { title: "1. Who we are", content: <p>SportsCardPulse is a sports card collection management app operated by TMR Tech, based in the United Kingdom. Questions about this policy: <a href="mailto:tom@tmrtech.co.uk" style={{ color: "#4F8EF7" }}>tom@tmrtech.co.uk</a></p> },
          ...
          { title: "5. Data retention", content: <p>Your data is retained while your account is active. Deletion requests are fulfilled within 30 days. Catalogue contributions are removed immediately upon consent withdrawal.</p> },
          ...
          { title: "8. Children", content: <p>SportsCardPulse is not directed at children under 13. We do not knowingly collect data from children.</p> },
