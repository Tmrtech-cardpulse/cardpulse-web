...
export const metadata: Metadata = pageMeta({
  ...
  description: 'Last updated May 2026. Operated by Thomas Michael Ratcliffe, United Kingdom.',
  path: '/privacy',
});

export default function Page() {
  return (
    <LegalShell title={'Privacy Policy'} meta={'Last updated May 2026. Operated by Thomas Michael Ratcliffe, United Kingdom.'}>
      {[
          { title: "1. Who we are", content: <p>SportsCardPulse is a sports card collection management app operated by Thomas Michael Ratcliffe, a sole trader based in the United Kingdom. Thomas Michael Ratcliffe is the data controller for the purposes of UK GDPR. Questions about this policy: <a href="mailto:tom@tmrtech.co.uk" style={{ color: "var(--c-accent)" }}>tom@tmrtech.co.uk</a></p> },
          ...
          { title: "6. Your rights (UK GDPR)", content: <p>You have the right to access, correct, export, or delete your personal data. Email <a href="mailto:tom@tmrtech.co.uk" style={{ color: "var(--c-accent)" }}>tom@tmrtech.co.uk</a>. You may also complain to the <a href="https://ico.org.uk" style={{ color: "var(--c-accent)" }}>ICO</a>.</p> },
          ...
          <section key={title} style={{ marginBottom: 32 }}>
            <h2 style={{ fontSize: "1rem", fontWeight: 700, color: "var(--c-accent)", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: 10 }}>{title}</h2>
        ...
        <p style={{ fontSize: "0.85rem", color: "#52566B" }}>© 2026 Thomas Michael Ratcliffe · United Kingdom · <a href="mailto:tom@tmrtech.co.uk" style={{ color: "var(--c-accent)" }}>tom@tmrtech.co.uk</a></p>
    </LegalShell>
  );
}
