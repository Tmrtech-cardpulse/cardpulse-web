...
export default function Page() {
  return (
    <LegalShell title={'Terms of Service'} meta={'Last updated May 2026. Operated by Thomas Michael Ratcliffe, United Kingdom.'}>
      {[
          ...
          { title: "12. Termination", content: <p>We may suspend or terminate your account if you breach these terms. You may delete your account at any time from within the app, or by contacting <a href="mailto:tom@tmrtech.co.uk" style={{ color: "var(--c-accent)" }}>tom@tmrtech.co.uk</a>.</p> },
          ...
          { title: "15. Contact", content: <p>Thomas Michael Ratcliffe, United Kingdom<br />Email: <a href="mailto:tom@tmrtech.co.uk" style={{ color: "var(--c-accent)" }}>tom@tmrtech.co.uk</a></p> },
        ].map(({ title, content }) => (
